...
if (rsvpForm) {
  ...
  rsvpForm.addEventListener("submit", (event) => {
    ...
    if (!action.startsWith("https://script.google.com/macros/s/") || action.includes("COLE_AQUI_SEU_DEPLOYMENT_ID")) {
      showFormStatus(
        "O RSVP ainda precisa ser conectado ao Google Apps Script. Configure a URL do Web App no index.html antes de publicar.",
        "error"
      );
      statusBox?.scrollIntoView({ behavior: "smooth", block: "center" });
      return;
